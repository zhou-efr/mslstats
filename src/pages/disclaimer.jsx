        ...
        <Container>
            ...
            <div className="bg-white px-6 lg:px-8">
                <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
                    <p className="text-base font-semibold leading-7 text-red-nekorporation-500">Disclaimer</p>
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p className='my-3'>
                            ...
                            (<a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://www.okta.com/privacy-policy/">lien RGPD</a>). Est ensuite sauvegardé dans une base de données
                            MongoDB Atlas (<a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://www.mongodb.com/legal/privacy-policy">lien RGPD</a>) la liste des streamers suivis au même titre
                            que l{"'"}email fourni à l{"'"}inscription.
                        </p>
                        <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
                            <li className="flex gap-x-3">
                                <CheckCircleIcon className="mt-1 h-5 w-5 flex-none text-red-nekorporation-500" aria-hidden="true" />
                                <span>
                                    ...
                                    récupérée auprès de Twitch via son API (<a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://www.twitch.tv/p/en/legal/privacy-notice/">lien RGPD</a>).
                        ...
                        <ul role="list" className="mt-8 max-w-xl space-y-8 text-gray-600">
                            <li className="flex gap-x-3">
                                <ShieldCheckIcon className="mt-1 h-5 w-5 flex-none text-red-nekorporation-500" aria-hidden="true" />
                                <span>
                                    <strong className="font-semibold text-gray-900">Vercel</strong> <a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://vercel.com/security">Security notice</a> / <a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://vercel.com/docs/concepts/analytics/privacy">analytics privacy</a>
                                </span>
                            </li>
                            <li className="flex gap-x-3">
                                <ShieldCheckIcon className="mt-1 h-5 w-5 flex-none text-red-nekorporation-500" aria-hidden="true" />
                                <span>
                                    <strong className="font-semibold text-gray-900">Mongo DB Atlas</strong> <a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://www.mongodb.com/cloud/atlas/security">Security notice</a>
                                </span>
                            </li>
                            <li className="flex gap-x-3">
                                <ShieldCheckIcon className="mt-1 h-5 w-5 flex-none text-red-nekorporation-500" aria-hidden="true" />
                                <span>
                                    <strong className="font-semibold text-gray-900">Auth 0</strong> <a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://auth0.com/security">Security, Privacy & Compliance</a>
                                </span>
                            </li>
                            <li className="flex gap-x-3">
                                <ShieldCheckIcon className="mt-1 h-5 w-5 flex-none text-red-nekorporation-500" aria-hidden="true" />
                                <span>
                                    <strong className="font-semibold text-gray-900">Twitch</strong> <a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="https://www.twitch.tv/jobs/fr-fr/legal/privacy-notice/">Privacy notice</a>
                                </span>
                            </li>
                        </ul>
                        <p className="mt-6">
                        ...
                        <p className="mt-6">
                            Pour plus de questions, de demandes de suppression, etc., pinguez-moi sur Discord ou envoyez un e-mail à <a rel="noreferrer" target={"_blank"} className='text-red-nekorporation-500 hover:text-red-nekorporation-700 active:text-pink-900' href="mailto:zhouefr@gmail.com">zhouefr@gmail.com</a>.
                        </p>
                        <p className="mt-6">
                            Bien à vous,<br />
                            Un humble panda.
