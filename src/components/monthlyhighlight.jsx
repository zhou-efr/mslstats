                    ...
                    <div className="text-center flex flex-col items-center gap-3">
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            <a
                                ...
                                className="rounded-md bg-red-nekorporation-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-nekorporation-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-nekorporation-500"
                            >
                                Voir le stream
                            </a>
