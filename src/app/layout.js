...
import {DiscordIcon, GithubIcon, InstagramIcon, TwitchIcon, TwitterIcon, YoutubeIcon} from "@/components/icons";
                ...
                <main className="border-t border-slate-200 lg:relative lg:mb-28 lg:ml-112 lg:border-t-0 xl:ml-120">
                    <div className="relative">
                        <div className="pt-16 pb-12 sm:pb-4 lg:pt-12">
                            ...
                            <div
                                className="divide-y divide-slate-100 sm:mt-4 lg:mt-8 lg:border-t lg:border-slate-100 py-10">
                                {children}
                            </div>
                        </div>
                    </div>
